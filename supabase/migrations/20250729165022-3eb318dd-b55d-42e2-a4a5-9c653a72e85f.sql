...
('22222222-2222-2222-2222-222222222222', 'João Santos', 'Foodie apaixonado por cozinha tradicional portuguesa. Trabalho em Belém, livre ao almoço!', 'Lisboa', 'lunch', ARRAY['traditional', 'seafood', 'meat'], ARRAY[], 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400'),
...
('44444444-4444-4444-4444-444444444444', 'Pedro Alves', 'Chef amador nos tempos livres. Sempre disposto a experimentar fusões e sabores internacionais.', 'Lisboa', 'both', ARRAY['spicy', 'exotic', 'modern'], ARRAY[], 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400'),
